...
classdef classDMCa < handle
    ...
    properties(GetAccess = 'public', SetAccess = 'private')
       ...
       % num_dUk = [];       % dU(k)
        ...
        opti_options = optimset('Display', 'off');
    end
    ...
    methods(Access = 'public')
        ...
        function init(obj)
            ...
            switch (obj.settings.type)
                case 'analytical'
                    % disp('initializing analytical implementation');
                    obj.init_anal();
                case 'numerical'
                    % disp('initializing numerical implementation');
                    obj.init_num();
                otherwise
...
%            disp(obj.U_min);
        ...
        function ret_u = calc_num(obj)
            ...
            % solver execution
            dUk = quadprog(obj.num_H, f, obj.num_A, b, [], [], x_min, x_max, [], obj.opti_options);
