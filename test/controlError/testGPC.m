...
%!assert(runAlg('1x1', @GPC, 'analytical', false) < 40)
%!assert(runAlg('1x1', @GPC, 'fast', false) < 40)
...
%!assert(runAlg('2x2', @GPC, 'analytical', false) < 20)
%!assert(runAlg('2x2', @GPC, 'fast', false) < 20)
%!assert(runAlg('2x2', @GPC, 'numerical', false) < 20)
