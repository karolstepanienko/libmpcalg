...
%!assert(runAlg('1x1RelativeTest', @MPCS, 'analytical', false) < 940)
%!assert(runAlg('1x1RelativeTest', @MPCS, 'fast', false) < 940)
%!assert(runAlg('1x1RelativeTest', @MPCS, 'numerical', false) < 940)

%!assert(runAlg('1x2', @MPCS, 'analytical', false) < 36)
%!assert(runAlg('1x2', @MPCS, 'fast', false) < 46)
